                        ...
                        <div class="card-body row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="created_at" name="created_at" autofocus value="<?= old('created_at'); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="nama_barang" class="col-sm-3 col-form-label">Nama Barang</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="nama_barang" name="nama_barang" autofocus value="<?= old('nama_barang'); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
